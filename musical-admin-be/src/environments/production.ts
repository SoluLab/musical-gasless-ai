...
export default (): ConfigInterface => {
	return {
		...
		GOOGLE_CLOUD_STORAGE_AUDIO_BUCKET: process.env.GOOGLE_CLOUD_STORAGE_AUDIO_BUCKET,
		GOOGLE_CLOUD_STORAGE_AUDIO_URL_EXPIRATION_TIME: process.env.GOOGLE_CLOUD_STORAGE_AUDIO_URL_EXPIRATION_TIME
	}
}
