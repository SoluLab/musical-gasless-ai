...
import QuestDataSource from '@modules/quest/data-source/quest'
import LeaderboardDataSource from '@modules/leaderboard/data-source/leaderboard'
...
export interface Datasources {
	...
	Quest: QuestDataSource
	Leaderboard: LeaderboardDataSource
}
...
export default () => {
	return {
		...
		Quest: new QuestDataSource(App.Models.Quest),
		Leaderboard: new LeaderboardDataSource(App.Models.Leaderboard),
	}
}
